...
class InputExample(object):
    ...
    def __init__(self, guid, text_a, text_b=None, label=None, x0=None, y0=None, x1=None, y1=None, weight=None):
        """
...
class InputFeatures(object):
    ...
    def __init__(self, input_ids, input_mask, segment_ids, label_id, weight, bboxes=None):
...
def convert_example_to_feature(
    ...
    if bboxes:
        ...
        return InputFeatures(
            input_ids=input_ids, input_mask=input_mask, segment_ids=segment_ids, label_id=example.label, weight=example.weight
        )
